...
class Preprocessor:
    ...
    def run(self):
        logger.info(f"Starting preprocessor with broker: {self.broker}, group: {self.group}, topic_from: {self.topic_from}, topic_to: {self.topic_to}, topics_list: {self.topics_list}, stats_interval_ms: {self.stats_interval_ms}, stats_cb: {self.stats_cb}")
